...
| **场景覆盖** | 6.8/10 | 基础功能覆盖好，复杂业务场景偏弱 |
| **问题发现能力** | 7.0/10 | 能测API契约和基础流程，难测并发/性能/真实故障 |
| **综合评分** | **7.5/10** | 框架优秀，但需补充复杂场景和性能测试 |
...
├── feature_manifest.py        # 78 个功能特性 → 用例映射
├── feature_cases/             # 32 个功能级用例
...
`feature_manifest.py` 提供 78 个功能特性的明确映射：
