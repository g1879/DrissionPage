...
class ChromiumElement(DrissionElement):
    ...
    def force_pseudo_state(self, forcedPseudoClasses: Union[bool, str, list, tuple] = None) -> ChromiumElement:
        """
        强制元素保持伪类状态（如active、hover 等）或特定伪类状态（如enabled、disabled、valid、visited 等），可接受bool、str、list、tuple类型。
        伪类名前不能有:。
        :param forcedPseudoClasses:
        传入True时保持元素hover时的样式，传入False时取消强制元素保持伪状态，传入str、list、tuple时传入状态名,可传入单个伪类名
        str格式：active,hover
